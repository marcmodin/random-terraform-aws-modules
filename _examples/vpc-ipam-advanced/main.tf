...
# output "vpc_eu_north_2" {
#   value = module.vpc_eu_north_2
# }


# module "vpc_eu_north_3" {
#   source              = "../../vpc"
#   name_prefix         = var.name_prefix
#   ipv4_ipam_pool_id   = local.pools.eu-north-1
#   ipv4_netmask_length = 24
...
# output "vpc_eu_north_3" {
#   value = module.vpc_eu_north_3
# }
